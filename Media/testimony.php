...
<?php if($isAdmin) : ?>
    ...
    <form id="videoForm" method="POST" action="add_testimony.php" class="add_leader" enctype="multipart/form-data">
  <label for="videoFile">Video File:</label>
  <input type="file" id="videoFile" name="videoFile" accept="videos/*" required>
  <label for="videoTitle">Title:</label>
  <input type="text" id="videoTitle" name="videoTitle" required>
  <label for="videoPreacher">speaker:</label>
...
$stmt = $pdo->query("SELECT * FROM testimony ORDER BY date DESC");
...
?>
    ...
    Your browser does not support the video tag.
       ...
       <?php if($isAdmin) : ?>
     <form class="remove_leader" action="remove_testimony.php" method="POST">
