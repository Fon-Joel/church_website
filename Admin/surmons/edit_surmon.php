...
if(isset($_GET['id'])){
    $editId=$_GET['id'];
    $query_fetch=mysqli_query($conn, "SELECT * FROM surmons WHERE id={$editId} ");
    ...
    $itemurl=$query['url'];
             ...
             if(isset($_POST['edit_item'])){
                ...
                $itemurl=$_POST['url'];
                $itemDate=$_POST['date'];
                $insertItem= mysqli_query($conn, "UPDATE surmons SET title='{$itemName}', preacher='{$itemRole}', url='{$itemurl}', date='{$itemDate}' WHERE id=$editId" );
            ...
            <form action='' enctype='multipart/form-data' method='post'  >
                ...
                <label for='itempreacher'>Teacher</label>
