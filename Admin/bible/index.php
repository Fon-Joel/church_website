...
$delId=$_GET['delete'];
$del_bible=mysqli_query($conn, "DELETE FROM bible_studies WHERE id=$delId");
}
?>
...
$id=$delId[$j];
$del_bible=mysqli_query($conn, "DELETE FROM bible_studies WHERE id=$id");
}
...
case 'edit' : 
    ...
    include "edit_bible_studies.php";
break;  ?>
<?php       
case 'add' :
...
<div class="col-lg-12 table-responsive">
    ...
    <form action="" method="post">
      <div class="col-xl-6 m-3"><button name="deletebible" type="submit" class="col-xl-3 btn btn-danger" onClick="return confirm('Do you want to delete the selected bibles_studies')" >Delete</button>
        <a href="index.php?source=add" class="col-xl-3 btn text-light btn-warning ">Add bible</a></div>
    ...
    <tr>
        <?php 
    $get_bible = mysqli_query($conn, "SELECT * FROM bible_studies");
    if(isset($_GET['page'])){
        $page = $_GET['page'];
    } else {
        $page = 1;
    ...
    $per_page = mysqli_query($conn, "SELECT * FROM bible_studies ORDER by id DESC LIMIT $startPage, $pageShow");
    $i=$reverse;
    ...
    ?>
            ...
            <td><?php echo "<a href='index.php?delete={$bible_id}' class='text-decoration-none' onClick='return confirm(\"Do you want to remove this bible?\")'>Delete</a>"; ?></td>
    </tr>
    <?php endforeach;  ?>
    </tbody>
    </table>
