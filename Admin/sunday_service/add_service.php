...
if(isset($_POST['add_service'])){
    ...
    $date=$_POST['date'];
    $url=$_POST['url'];
    $add_service_query = mysqli_query($conn, "INSERT INTO videos (title, preacher, url, date) VALUES ('$Title', '$Preacher', '$url','$date')");
 ...
 ?>       
        ...
        <?php  if ($add_service_query){ echo "<p class='text-success'>Item Added Successfully:    <a class='text-decoration-none' href='index.php'>View Service info</a></p>";}  ?>
