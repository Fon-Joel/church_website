...
<?php if($isAdmin) : ?>
    ...
    <form id="videoForm" method="POST" action="add_surmons.php" class="add_leader">
...
$stmt = $pdo->query("SELECT * FROM surmons ORDER BY date DESC");
...
?>
    <?php foreach ($videos as $video) : ?>
       ...
       <?php if($isAdmin) : ?>
     <form class="remove_leader" action="remove_surmons.php" method="POST">
