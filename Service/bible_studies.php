...
<?php if($isAdmin) : ?>
    ...
    <form id="videoForm" method="POST" action="add_studies.php" class="add_leader" enctype="multipart/form-data">
...
$stmt = $pdo->query("SELECT * FROM bible_studies ORDER BY date DESC");
...
?>
    ...
    Your browser does not support the video tag.
       ...
       <?php if($isAdmin) : ?>
     <form class="remove_leader" action="remove_studies.php" method="POST">
